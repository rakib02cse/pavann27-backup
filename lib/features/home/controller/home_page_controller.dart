...
class HomePageController extends GetxController {
  ...
  final RxList<HomePageModel> allAllies = <HomePageModel>[
    HomePageModel(
      ...
      reviews: 9,
      hours: 410,
      bio: "Hey, I'm around if you feel like talking and share your story.",
      status: 'Online now',
      isOnline: true,
      isVerified: true,
      canTalkNow: true,
    ...
    HomePageModel(
      ...
      reviews: 9,
      hours: 410,
      bio: 'I was heartbroken after breakup  due to long distance.',
      status: 'On a call',
      isOnline: false,
      isVerified: true,
      canTalkNow: false,
    ...
    HomePageModel(
      ...
      reviews: 9,
      hours: 410,
      bio: "Ready to Chat? I'm here to listen your thoughts anytime!",
      status: 'Online now',
      isOnline: true,
      isVerified: true,
      canTalkNow: true,
    ...
    HomePageModel(
      ...
      reviews: 9,
      hours: 410,
      bio: 'I felt shattered after my boyfriend treated me as an option. ',
